...
CREATE TABLE labels (
    ...
    label_name   VARCHAR2(64)
);

ALTER TABLE labels ADD CONSTRAINT labels_pk PRIMARY KEY ( label_id );
...
CREATE TABLE sales_products (
    sale_prod_id   INTEGER NOT NULL,
    sale_quantity  INTEGER,
    sale_id        INTEGER NOT NULL,
    prod_id        INTEGER NOT NULL
);

ALTER TABLE sales_products ADD CONSTRAINT sales_products_pk PRIMARY KEY ( sale_prod_id );
...
ALTER TABLE employees
    ADD CONSTRAINT employees_positions_fk FOREIGN KEY ( pos_id )
        REFERENCES positions ( pos_id );

ALTER TABLE products
    ADD CONSTRAINT products_artists_fk FOREIGN KEY ( artist_id )
...
ALTER TABLE products
    ADD CONSTRAINT products_labels_fk FOREIGN KEY ( label_id )
